...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex w-full items-center gap-3 rounded-xl px-3 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 transition hover:bg-slate-100 dark:bg-slate-800 hover:text-slate-900 dark:text-slate-100 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white"
    >
